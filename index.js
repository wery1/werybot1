...
LolKey = 'dappaGanz' //beli di https://api.lolhuman.xyz

//Settings => Semua Aturnya Disini <=
fake = 'EITS ADA ANTIDELETE🐦:v'
namabot = 'START BOT' //Ubah jadi nama bot lu
namaowner = 'wery' //Ubah jadi nama lu
nomerlu = '6287888550220' //Ubah jadi nomer lu
...
console.log(banner.string)
   ...
   qrcode.generate(qr, { small: true })
	console.log(color('(+)','white'), color('AlfaGanzz','red'), color('(+)','white'), color(' SQAN CODENYA','aqua'), color('SUBREK YT Smart Bot','yellow'))
})
...
//MENU
                ...
                if (isLimit(sender)) return reply(dpa.limitend)
                if (isBanned) return reply(dpa.baned)
                ngonrona = await fetchJson('https://dapuhy-api.herokuapp.com/api/others/corona?negara=indonesia')
...
*⧆ INFO CORONA*
_kasus: ${ngonrona.kasus}_
_meninggal: ${ngonrona.meninggal}_
_sembuh: ${ngonrona.sembuh}_
